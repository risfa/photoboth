...
<html lang="en">
	<head>
		...
		<?php
		require_once($pathdir."admin/assets/db/db.php");		date_default_timezone_set("Asia/Bangkok");
		//ini_set('display_errors', 1);    //		//error_reporting(error_reporting() & ~E_STRICT);
		//css
		...
		<style>
			...
			.bgLogin
			{
				background:url("admin/assets/images/Image-login-RFID.png");
				height:600px;
				width:500px;
